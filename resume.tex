...
expression in Transcriptome-wide Association Studies, improving power to
detect genes associated with seven diseases (Bhutani*, Sarkar*, et al., in
...
\section*{Skills}
\begin{itemize}
\item Python, Theano, R, bash
\item Linux, DRMAA (Platform LSF, Univa Grid Engine, Portable Batch System)
\end{itemize}
